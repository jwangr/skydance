...
export default function SnapScrollSection({ children, className = '' }) {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const isEntering = rect.top > 0 && rect.top < viewportHeight * 0.95;
      
      if (isEntering && !isSnapping) {
        isScrolling = true;
        setIsSnapping(true);
        
        // Smooth scroll to snap section to top
    ...
    <div className="bg-gray-50">
      <section className="h-screen flex items-center justify-center bg-blue-100">
        <div className="text-center">
          ...
          <p className="text-gray-600">The next section will snap to the top when you scroll to it</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 py-20">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white/10 backdrop-blur p-6 rounded-lg">
              ...
              <p>Your content goes here with images, divs, and any other children.</p>
            </div>
            <div className="bg-white/10 backdrop-blur p-6 rounded-lg">
              <h3 className="text-2xl font-semibold mb-3">Feature Two</h3>
              <p>The component accepts any React children you want to include.</p>
            </div>
          </div>
